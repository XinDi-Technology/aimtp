  ...
  try {
    ...
    try {
      const sanitized = DOMPurify.sanitize(result, {
        ...
        // MathJax v4 使用 mjx-* 自定义元素（Custom Elements），必须全部放行
