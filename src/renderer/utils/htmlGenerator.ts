  ...
  try {
    ...
    try {
      const sanitized = DOMPurify.sanitize(result, {
        ...
        ALLOWED_ATTR: ['href', 'src', 'alt', 'title', 'class', 'style', 'target', 'id', 'data-processed', 'd', 'fill', 'stroke', 'stroke-width', 'transform', 'x', 'y', 'width', 'height', 'cx', 'cy', 'r', 'rx', 'ry', 'viewBox', 'preserveAspectRatio', 'xmlns', 'font-family', 'font-size', 'text-anchor', 'dominant-baseline', 'marker-end', 'marker-start', 'type', 'checked', 'disabled', 'data-line', 'data-math', 'aria-label', 'role', 'rev'],
      } as any);
