 ...
 */
export const getHljsBaseStyles = (fontSize: number): string => {
  return `.hljs{display:block;overflow-x:visible;overflow-wrap:break-word;word-wrap:break-word;white-space:pre-wrap;padding:0;border-radius:6px;font-size:${fontSize}px;line-height:1.5}`;
};
